          ...
          <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    Payment : <strong>{{ $order->payment->bank }} {{ $order->payment->an!=null ? ' | '.$order->payment->an:''}}{{ $order->payment->norek != null ? ' | '.$order->payment->norek:''}}</strong>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4">
                ...
                <hr>
                <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#asdmodal-default"><i class="fas fa-plus"></i> Add Service</button>
              ...
              <div class="card-footer">
                    <div class="float-right">
                        <a href="{{ route('order.print', $order->id) }}" id="" class="btn btn-success" href="#" role="button"><span class="fa fa-print"></span> Print</a>
                    </div>
              </div>
              <!-- /.card-body -->
            </div>
...
<div class="modal fade" id="asdmodal-default">
