      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-sm table-striped" width="100%">
                  <thead>
                  ...
                  <tr>
                    ...
                    <td>{{ $order->payment->bank }}  {{ $order->payment->an!=null ? ' a.n '.$order->payment->an:''}}{{ $order->payment->norek != null ? ' , '.$order->payment->norek:''}}</td>
                    <td>
                      @if($order->images)
                    ...
                    <td class="text-center">
                      <form action="{{ route('order.destroy', $order->id) }}" method="post">
                        ...
                        <div class="d-flex flex-row bd-highlight mb-3">
                          ...
                          @endif
                          <a href="{{ route('order.print', $order->id) }}" id="" class="mr-1 btn btn-success btn-sm" href="#" role="button">print</a>
