              ...
              <div class="card-body">
                <form action="{{ route('order.store') }}" method="post">
                    ...
                    <div class="col-sm-10">
                      <select required name="payment" class="form-control">
                        ...
                        @foreach($payments as $payment)
                          <option value="{{ $payment->id }}">{{ $payment->bank }} {{ $payment->an!=null ? ' | '.$payment->an:''}}{{ $payment->norek != null ? ' | '.$payment->norek:''}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" required class="form-control"name="first" value="Anonim" placeholder="First Name*">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="no" class="form-control" id="inputPassword3">
                    </div>
                  </div>
                  <div class="form-group row">
