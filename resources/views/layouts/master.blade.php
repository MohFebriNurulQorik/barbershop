  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light mb-5 ">
      <div class="container flex justify-content-around align-items-center align-self-center">
        <a class="navbar-brand align-items-center align-self-center" href="/"><img src="{{ asset('img/logo.jpeg') }}" width="85" alt=""><span class="logo"> <span class="logo-warna">K.E.N</span> Barbershop</span></a>
